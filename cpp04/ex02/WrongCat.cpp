...
WrongCat::WrongCat() : AWrongAnimal("WrongCat"), myBrain_(new Brain()) {
	std::cout << "Wrong cat was born" << std::endl;
}

WrongCat::WrongCat(const WrongCat &Another) : AWrongAnimal(Another), myBrain_(Another.myBrain_) {
...
void	WrongCat::purevirtual(void) const {
